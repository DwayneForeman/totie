...
type Frequency = 'rarely' | '1-2' | '3-4' | 'daily' | null;
...
export default function DeliveryFrequency() {
  ...
  const handleNext = () => {
    if (selected) {
      updateOnboardingData({ deliveryFrequency: selected });
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          <View style={styles.header}>
            ...
            <View style={styles.speechBubbleWrap}>
              ...
              <View style={styles.speechBubble}>
                <Text style={styles.question}>How often do you order delivery?</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.options}>
            <SelectionCard
              emoji="🌙"
              title="Rarely (few times a month)"
              selected={selected === 'rarely'}
              onPress={() => setSelected('rarely')}
            />
            <SelectionCard
              emoji="📅"
              title="1-2 times per week"
              selected={selected === '1-2'}
              onPress={() => setSelected('1-2')}
            />
            <SelectionCard
              emoji="🔥"
